// we have a guessing game where i am to incoperate all i've learnt in it. which is right from *object *boolean, *function,the and & or operator, variables, loops, variable, conditional statements,comparison  and sprinkle of array.
