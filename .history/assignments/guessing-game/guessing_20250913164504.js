// we have a guessing game where i am to inculcate all ive learnt in it. which is right from *object *boolean, *function,the and & or operator, variables, loops, variable, conditional statements,compario  and sprinkle of array.
...
const baskets = [ //this is an array of objects,holding each baskets objects
    ...
    function checkBasket(basketNumber) {
            let instructions = prompt("you have 3 choices : Basket 1 , Basket 2, or Basket 3. " + "choose one fruit basket");
