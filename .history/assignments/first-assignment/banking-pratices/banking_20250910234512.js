...
let account2NGN = account1.currency === "NGN" ? account1.balance : account1.balance * exchangeRate;
let account3NGN = account1.currency === "NGN" ? account1.balance : account1.balance * exchangeRate;
let account4NGN = account1.currency === "NGN" ? account1.balance : account1.balance * exchangeRate;
