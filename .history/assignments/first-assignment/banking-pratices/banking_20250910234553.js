...
let account2NGN = account2.currency === "NGN" ? account2.balance : account1.balance * exchangeRate;
let account3NGN = account3.currency === "NGN" ? account3.balance : account1.balance * exchangeRate;
let account4NGN = account4.currency === "NGN" ? account4.balance : account1.balance * exchangeRate;
