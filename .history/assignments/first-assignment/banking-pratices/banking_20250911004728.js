...
console.log(`${account2.name} new balance is ${account2.currency} ${account2.balance} NGN ${account1NGN}`)
console.log(`${account3.name} new balance is ${account3.currency} ${account3.balance} NGN ${account1NGN}`)
console.log(`${account4.name} new balance is ${account4.currency} ${account4.balance} NGN ${account1NGN}`)