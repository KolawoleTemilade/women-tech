...
let account1NGN = account1.balance * exchangeRate[account1.currency]
let account2NGN = account2.balance * exchangeRate[account1.currency]
let account3NGN = account3.balance * exchangeRate[account1.currency]
let account4NGN = account4.balance * exchangeRate[account1.currency]

console.log(account1NGN);
console.log(account2NGN);
console.log(account3NGN);
console.log(account4NGN);
