...
console.log("accounts before conversion"account1.balance, account2.balance, account3.balance, account4.balance)
...
console.log("ac"account1NGN, account2NGN, account3NGN, account4NGN);
