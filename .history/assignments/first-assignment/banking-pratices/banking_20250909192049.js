...
if (account1.currency == account2.currency) {
    console.log (`${account2}'s account credited with ${account2.currency += deposit} &`);
    console.log (`Toluwani just got debited and balance remains ${account1.balance -= deposit}`);
}else{
