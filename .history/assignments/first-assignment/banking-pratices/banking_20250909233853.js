...
if (account1.type === "savings") {
    ...
    console.log (`this is a checkings account type ${account1.balance + deposit - withdawal}`) //so for this, i was thinking if i should multiply the deposit by the number of days(30) and also the withdrawal, but im not too certain as deposit and withdrawals are not made everyday
}
