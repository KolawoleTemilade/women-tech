...
if (account1.type === "savings") {
    console.log (`${account1.currency + account1.balance * rate * time}`)
    console.log (`the new balance for account1 with interest is now ${account1.currency + account1.balance * rate * time + account1.balance}`)
} else { 
