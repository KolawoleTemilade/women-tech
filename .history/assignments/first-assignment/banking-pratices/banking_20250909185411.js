...
console.log (`this is the new balance for  : USD ${account2.balance}`)
...
if (account1.balance > withdawal) {
    console.log (`this is the new balance for account1 ${account1.balance -= withdawal}`)
}else{
...
if (account3.balance > withdawal) {
    console.log (`this is the new balance for account1 ${account3.balance -= withdawal}`)
}else{
