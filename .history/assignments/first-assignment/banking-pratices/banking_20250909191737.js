...
if (account1.currency == account2.currency) {
    ...
    console.log (`Toluwani just got debited and balance remains ${account1.currency -= deposit}`);
}else{
    console.log ("Transfer failed: currency mismatch")
}

if (account2.currency === account3.currency) {
    console.log (`Mariam's account credited with ${account3.currency += deposit} &`);
    console.log (`Eduaina just got debited and balance remains ${account1.currency -= deposit}`);
}else{
    console.log ("Transfer failed: currency mismatch")
}