...
if (account1.type === "savings") {
    ...
    console.log(`interest gained i${account1.currency + " " + interest}`)
...
if (account3.type === "savings") {
    let interest = account1.balance * rate 
    console.log(`interest gained ${account3.currency + " " + interest}`)
...
if (account4.type === "savings") {
    let interest = account1.balance * rate 
    console.log(`interest gained ${account4.currency + " " + interest}`)
