...
console.log (`${account2.name} new balance is ${account2.currency} ${account1.balance}`)
console.log (`${account3.name} new balance is ${account1.currency} ${account1.balance}`)
console.log (`${account4.name} new balance is ${account1.currency} ${account1.balance}`)