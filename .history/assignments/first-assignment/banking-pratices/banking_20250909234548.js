...
if (account1.type === "savings") {
    ...
    console.log (`new balance for ${account1.name} with checking is now ${account1.balance + deposit - withdawal}`)
...
if (account2.type === "savings") {
    ...
    console.log (`new balance for ${account2.name} with checking is now ${account2.balance + deposit - withdawal}`)
};
...
if (account3.type === "savings") {
    ...
    // console.log (account3.balance + deposit - withdawal) 
    console.log (`new balance for ${account3.name} with checking is now ${account3.balance + deposit - withdawal}`)
};
...
if (account4.type === "savings") {
    ...
    // console.log (account4.balance + deposit - withdawal) #

    console.log (`new balance for ${account4.name} with checking is now ${account4.balance + deposit - withdawal}`)
}