...
function showList (){
    ...
    for (i = 0; i < items.length; i++) { //the length is an array method that gets the list of all mt items without me having to manually count my item
        console.log((i + 1) + " " + items[1]) //the i +1 is like saying 0+1 for numbering my items list
    }
}
cl